...
/* Size of the robot ---------------------------------------------------------*/
const float length_a = 48; // femur по осям
const float length_b = 81.5;  // tiba 
const float length_c = 33;  // coxa 
const float length_side = 79;  //длина базы
...
void setup()
{
  ...
  // w 0 1: stand            // Встать
  // w 0 0: sit              // Сесть   
  // w 1 x: forward x step   // Впрерёд
  // w 2 x: back x step      // Назад 
  // w 3 x: right turn x step   // Поворот направо
  // w 4 x: left turn x step    // Поворот налево
  // w 5 x: hand shake x times  // Помахать рукой
  // w 6 x: hand wave x times   // Помахать по другому 
